  ...
  return (
    <div className="flex flex-col h-full space-y-4">
      ...
      <Card className="glass-card border-primary/20">
        <CardHeader>
          <CardTitle className="text-2xl">Automation Playground</CardTitle>
        </CardHeader>
      </Card>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        ...
        <TabsContent value="automation-test">
          <Card className="glass-card border-primary/20">
      ...
      <div className="grid grid-cols-2 gap-4 flex-1 min-h-0">
            ...
            {mode === "ai" && (
              <div className="space-y-4">
                ...
                <div className="flex gap-2">
                  <Button variant="outline" className="flex-1 border-primary/30 hover:border-primary/50 bg-transparent">
                    Compare Models
                  </Button>
                  <Button variant="outline" className="flex-1 border-primary/30 hover:border-primary/50 bg-transparent">
                    Version History
        ...
        <Card className="glass-card border-primary/20 flex flex-col">
          <Tabs value={selectedView} onValueChange={setSelectedView} className="flex flex-col h-full">
            <CardHeader className="gradient-overlay border-b border-primary/10">
              <TabsList className="glass-card border border-primary/20 w-full justify-start">
                <TabsTrigger
                  value="console"
            ...
            <CardContent className="flex-1 p-4 overflow-auto">
              <TabsContent value="console" className="mt-0 space-y-2 h-full">
                {logs.map((log, idx) => (
                  <div
                    key={idx}
      ...
      <Card className="glass-card border-primary/20">
        <CardContent className="p-4">
          <Tabs defaultValue="logs" className="w-full">
            ...
            <TabsContent value="logs" className="mt-0 max-h-[150px] overflow-auto">
            ...
            <TabsContent value="ai" className="mt-0 max-h-[150px] overflow-auto">
              <div className="space-y-2">
